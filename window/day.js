...
export async function render(main, T, which) {
  ...
  ${tabs}
  <form id="df" class="row"><input type="text" id="dh" placeholder="any citizen's handle" aria-label="any citizen's handle"><button>show their public day</button></form>
...
async function publicDay(main, T, handle, date) {
  ...
  <form id="df" class="row"><input type="text" id="dh" placeholder="another citizen's handle" aria-label="another citizen's handle"><button>show their public day</button></form>
